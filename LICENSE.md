...
Portions of this software (`src/web-ext-rdp.js`) are vendored from Mozilla's
[web-ext](https://github.com/mozilla/web-ext) project and are licensed under the
Mozilla Public License 2.0 (MPL-2.0); see that file's header for details.
